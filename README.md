...
- Mutual exclusion of the seat booking process is enforced at the database level using `btree_gist`.
...
- Built with Java Spring Boot, with separate models, repositories, controllers, services, and DTOs to handle frontend requests and database communication.
...
- Built with Next.js, with a landing page, a user tab, and an admin tab.
